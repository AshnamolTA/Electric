    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('body_object', models.ManyToManyField(null=True, to='shop.lightbodycolour')),
                ('colour_object', models.ManyToManyField(null=True, to='shop.lightcolour')),
                ('material_object', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='shop.material')),
                ('shape_object', models.ManyToManyField(null=True, to='shop.shape')),
